...
if __name__ == '__main__':
    ...
    fig.suptitle('Skin Lesion', fontsize=45)
    ...
    ax[0, 2].set_title('Macro F1-score', fontsize=30)
    ...
    lgd2 = fig.legend(handles, labels, bbox_to_anchor=(0.974, 0.55))

    handles, labels = ax[0, 3].get_legend_handles_labels()
    lgd3 = fig.legend(handles, labels, bbox_to_anchor=(0.954, 0.82))
