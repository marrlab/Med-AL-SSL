...
if __name__ == '__main__':
    if arguments.run_batch:
        states = [
            ...
            ('semi_supervised', None, 'simclr_with_al', 'learning_loss', False, 'simclr'),
            ...
            ('semi_supervised', None, 'auto_encoder_with_al', 'learning_loss', False, 'autoencoder'),
            ...
            ('active_learning', 'learning_loss', None, None, True, 'pretrained'),
